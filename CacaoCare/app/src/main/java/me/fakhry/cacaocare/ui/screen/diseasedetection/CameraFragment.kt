...
import me.fakhry.cacaocare.databinding.FragmentCameraBinding
import me.fakhry.cacaocare.util.createFile
                ...
                imageCapture.takePicture(
                    ...
                    object : ImageCapture.OnImageSavedCallback {
                        ...
                        override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                            ...
                            setFragmentResult(
                                DiseaseDetectionFragment.CAMERA_X_IS_BACK_CAMERA,
                                bundleOf("isBackCamera" to isBackCamera)
                            )
                            setFragmentResult(
                                DiseaseDetectionFragment.CAMERA_X_RESULT,
